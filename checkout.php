    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- here once the user confirms of what they want to buy is right?,and they want to finish the shopping/order, the system will request  for there location where is the right one and then send the shoppings to the buyer -->

...
if (isset($_POST['form1'])) {
    ...
    // read and add customer location to the database and also locate the buyer just incase they have made a request of a product then add it to the database
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="cust_cname" value="<?php if (isset($_POST['cust_cname'])) {
                                                                                                        ...
                                                                                                        } ?>" placeholder="If school, school name">
                                </div>
                                <div class="col-md-6 form-group">

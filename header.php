			...
			<div class="row inner">
				...
				<div class="col-md-5 right">
					<ul>
						...
						?>
							<li><a href="choose_login.php"><i class="fa fa-sign-in"></i> <?php echo LANG_VALUE_9; ?></a></li>
							<li><a href="Choose_registration.php"><i class="fa fa-user-plus"></i> <?php echo LANG_VALUE_15; ?></a></li>
						<?php
						}
						?>

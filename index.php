                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <h4>
                                Shs. <?php echo $row['p_current_price']; ?> 
                                    <?php if($row['p_old_price'] != ''): ?>
                                    <del>
                                    Shs. <?php echo $row['p_old_price']; ?>
                                    </del>
                                    <!-- here is the items left for the product -->
                                    <br>
                                    <span style="color: red;"><?php echo $row['p_qty']; ?>  Items Left</span>
